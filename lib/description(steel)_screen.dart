...
class DescriptionPagest extends StatefulWidget {
   const DescriptionPagest({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _DescriptionPagestState createState() => _DescriptionPagestState();



}

class _DescriptionPagestState extends State<DescriptionPagest> {
  XFile? _image;
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child:  const Center(child: Text("حداد",style: TextStyle(fontSize: 24, color: Color.fromARGB(255, 255, 255, 255))
                          ),
                          ),
                          ),
                        const Text(
  ...
  String? phoneNumber = await DatabaseProvider().getUserPhoneNumber(userId);
      ...
      String serviceName = "حداد"; // The service name is static, as provided.

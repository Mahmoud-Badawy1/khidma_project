...
import 'package:khidma_app/db/db.dart';
import 'package:khidma_app/users-screens/orders_screen.dart';
...
class DescriptionPage extends StatefulWidget {
  ...
  const DescriptionPage({super.key, required this.khidma});
    ...
    if (locationData.latitude != null && locationData.longitude != null) {
      ...
      if (isMapAvailable != null && isMapAvailable) {
        await MapLauncher.showMarker(
          ...
          coords: Coords(locationData.latitude!, locationData.longitude!),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Text(
                                    widget.khidma, // Use widget.khidma here
                        ...
                        child: TextButton(
                          onPressed: () async {
                            ...
                            if (_formKey.currentState?.validate() ?? false) {
                              ...
                              String serviceName =
                                  "كهربائى"; // The service name is static, as provided.

...
class DescriptionPagemah extends StatefulWidget {
   const DescriptionPagemah({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _DescriptionPagemahState createState() => _DescriptionPagemahState();



}

class _DescriptionPagemahState extends State<DescriptionPagemah> {
  XFile? _image;
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child:  const Center(child: Text("محارة",style: TextStyle(fontSize: 24, color: Color.fromARGB(255, 255, 255, 255))
                          ),
                          ),
                          ),
                        const Text(
  ...
  String? phoneNumber = await DatabaseProvider().getUserPhoneNumber(userId);
      ...
      String serviceName = "محارة"; // The service name is static, as provided.

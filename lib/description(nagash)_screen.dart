...
class DescriptionPagenagash extends StatefulWidget {
   const DescriptionPagenagash({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _DescriptionPagenagashState createState() => _DescriptionPagenagashState();



}

class _DescriptionPagenagashState extends State<DescriptionPagenagash> {
  XFile? _image;
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child:  const Center(child: Text("نقاش",style: TextStyle(fontSize: 24, color: Color.fromARGB(255, 255, 255, 255))
                          ),
                          ),
                          ),
                        const Text(
  ...
  String? phoneNumber = await DatabaseProvider().getUserPhoneNumber(userId);
      ...
      String serviceName = "نقاش"; // The service name is static, as provided.

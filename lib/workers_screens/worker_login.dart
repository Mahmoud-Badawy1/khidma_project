...
class WorkerLoginPage extends StatefulWidget {
  ...
  _WorkerLoginPageState createState() => _WorkerLoginPageState();
}
...
class _WorkerLoginPageState extends State<WorkerLoginPage> {
  ...
  void _workerlogin(BuildContext context) async {
        ...
        child: Form(
          ...
          child: Column(
            children: <Widget>[
                ...
                child: Container(
                  ...
                  decoration: const BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color:
                            Color(0x40000000), // Shadow color with transparency
                      ...
                      children: <Widget>[
                        ...
                        Image.asset(
                          ...
                          width: MediaQuery.of(context).size.width *
                              1, // Set the width to 50% of the screen width
                ...
                children: [
                  TextButton(
                    onPressed: () => Navigator.pushNamed(context,
                        '/forgotPassword'), // Assuming '/forgotPassword' is the route to your forgot password screen
                    child: const Text(
                      'نسيت كلمة السر؟',
                      style: TextStyle(
              ...
              ElevatedButton(
                onPressed: () => //_workerlogin(context),
                Navigator.pushReplacementNamed(context, '/present'),
              ...
              TextButton(
                onPressed: () {
                  Navigator.pushNamed(
                      context, '/workersignup'); // Navigate to signup screen
                },
...
class BottomCurveClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    Path path = Path();
    path.lineTo(0,
        size.height - curveDepth); // Line to the start of the curve on the left

...
class DescriptionPagetv extends StatefulWidget {
   const DescriptionPagetv({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _DescriptionPagetvState createState() => _DescriptionPagetvState();



}

class _DescriptionPagetvState extends State<DescriptionPagetv> {
  XFile? _image;
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child:  const Center(child: Text("تصليح دش وتليقزيون",style: TextStyle(fontSize: 24, color: Color.fromARGB(255, 255, 255, 255))
                          ),
                          ),
                          ),
                        const Text(
  ...
  String? phoneNumber = await DatabaseProvider().getUserPhoneNumber(userId);
      ...
      String serviceName = "تصليح دش وتليقزيون"; // The service name is static, as provided.

...
class DescriptionPagenagar extends StatefulWidget {
   const DescriptionPagenagar({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _DescriptionPagenagarState createState() => _DescriptionPagenagarState();



}

class _DescriptionPagenagarState extends State<DescriptionPagenagar> {
  XFile? _image;
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child:  const Center(child: Text("نجار",style: TextStyle(fontSize: 24, color: Color.fromARGB(255, 255, 255, 255))
                          ),
                          ),
                          ),
                        const Text(
  ...
  String? phoneNumber = await DatabaseProvider().getUserPhoneNumber(userId);
      ...
      String serviceName = "نجار"; // The service name is static, as provided.
